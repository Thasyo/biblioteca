  ...
  <body>
    ...
    <form method="post" action="/autor/cadastro" class="p-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= $model->getDataNascimento() ?>" name="data_nascimento" id="data_nascimento">
        </div>

        <div class="mb-3">
            <label for="cpf" class="form-label">CPF</label>
            <input type="text" class="form-control" value="<?= $model->getCPF() ?>" name="cpf" id="cpf">
        </div>
